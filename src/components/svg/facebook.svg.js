...
const FacebookSvgIcon = ({ width, height, title, className, style }) => {
  ...
  return (
    ...
    >
      ...
      <use fill="#1977f3" xlinkHref={`#a_${idPrefix}`}></use>
      <use fillOpacity="0" stroke="#000" strokeOpacity="0" xlinkHref={`#a_${idPrefix}`}></use>
      <g>
        <use fill="#fefefe" xlinkHref={`#b_${idPrefix}`}></use>
        <use
          fillOpacity="0"
          stroke="#000"
          strokeOpacity="0"
