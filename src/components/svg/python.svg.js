...
const PythonSvgIcon = ({ width, height, title, className, style }) => {
  const idPrefix = (
...
PythonSvgIcon.propTypes = {
  width: PropTypes.string.isRequired,
  height: PropTypes.string,
  title: PropTypes.string
}

PythonSvgIcon.defaultProps = {
  height: null,
  title: null
}

export default PythonSvgIcon
